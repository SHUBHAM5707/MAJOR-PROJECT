          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    const SkCircularImage(image: SkImages.user,width: 80,height: 80),
                    TextButton(onPressed: () {},child: const Text('change picture picture')),
                  ],
                ),
              ),
              ...
              const SkSectionHeading(title: 'Profile Information',showActionButton: false,),
              const SizedBox(height: SkSizes.spaceBtwIteam),
              ...
              const SkSectionHeading(title: 'Personal Information',showActionButton: false,),
              const SizedBox(height: SkSizes.spaceBtwIteam),
              ...
              ProfileMenu(title:'number',value: controller.user.value.phoneNumber,onPressed: (){},),
              ProfileMenu(title:'gender',value: 'male',onPressed: (){},),
              ProfileMenu(title:'dob',value: '10/10/20',onPressed: (){},),
              const Divider(),
              const SizedBox(height: SkSizes.spaceBtwIteam),
