...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.black ),
    titleMedium: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w500,color: Colors.black ),
    titleSmall: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w400,color: Colors.black ),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w600,color: Colors.black.withOpacity(0.5) )
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.white ),
    titleMedium: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w500,color: Colors.white ),
    titleSmall: const TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w400,color: Colors.white ),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.w600,color: Colors.white.withOpacity(0.5) )
  );
